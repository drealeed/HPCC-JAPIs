...
public class WsWorkunitsLocator extends org.apache.axis.client.Service implements org.hpccsystems.ws.client.gen.wsworkunits.v1_74.WsWorkunits {
    ...
    private java.lang.String WsWorkunitsServiceSoap_address = "http://10.173.160.101:8010/WsWorkunits?ver_=1.74";
    ...
    public org.hpccsystems.ws.client.gen.wsworkunits.v1_74.WsWorkunitsServiceSoap getWsWorkunitsServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public org.hpccsystems.ws.client.gen.wsworkunits.v1_74.WsWorkunitsServiceSoap getWsWorkunitsServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.hpccsystems.ws.client.gen.wsworkunits.v1_74.WsWorkunitsServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                org.hpccsystems.ws.client.gen.wsworkunits.v1_74.WsWorkunitsServiceSoapStub _stub = new org.hpccsystems.ws.client.gen.wsworkunits.v1_74.WsWorkunitsServiceSoapStub(new java.net.URL(WsWorkunitsServiceSoap_address), this);
                _stub.setPortName(getWsWorkunitsServiceSoapWSDDServiceName());
                return _stub;
            }
        }
